		...
		if (0 == dead)
		{
			if (0 < powerup_state)
			{
				...
				else
				{
					...
					else if ((0 < horizontal_speed && 0 == sf::Keyboard::isKeyPressed(sf::Keyboard::D) &&
						1 == sf::Keyboard::isKeyPressed(sf::Keyboard::A)) ||
						(0 > horizontal_speed && 0 == sf::Keyboard::isKeyPressed(sf::Keyboard::A) &&
...
void Mario::update(const unsigned i_view_x, MapManager& i_map_manager)
{
	...
	if (0 == dead)
	{
		...
		if (0 == crouching)
		{
			if (0 == sf::Keyboard::isKeyPressed(sf::Keyboard::D) &&
				1 == sf::Keyboard::isKeyPressed(sf::Keyboard::A))
			{
				moving = 1;
			...
			if (0 == sf::Keyboard::isKeyPressed(sf::Keyboard::A) &&
				1 == sf::Keyboard::isKeyPressed(sf::Keyboard::D))
			{
				moving = 1;
		...
		if (0 < powerup_state)
		{
			if (1 == sf::Keyboard::isKeyPressed(sf::Keyboard::C) || 1 == sf::Keyboard::isKeyPressed(sf::Keyboard::S))
			{
				if (0 == crouching)
				{
					crouching = 1;
		...
		if (1 == sf::Keyboard::isKeyPressed(sf::Keyboard::Space) || 1 == sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
		{
